...
export function get_capture_groups(regex) {
    try {
        ...
        wasm.get_capture_groups(retptr, ptr0, len0);
...
const CaptureGroupFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_capturegroup_free(ptr >>> 0, 1));
/**
*/
export class CaptureGroup {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(CaptureGroup.prototype);
        obj.__wbg_ptr = ptr;
        CaptureGroupFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CaptureGroupFinalization.unregister(this);
        return ptr;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('regex_syntax_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
