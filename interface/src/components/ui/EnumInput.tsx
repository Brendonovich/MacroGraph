...
export function SelectInput<TOption>(props: SelectInputProps<TOption>) {
	return (
		...
		>
			<Select.Trigger class="w-full text-left pl-2 py-0.5 rounded bg-neutral-700 ui-expanded:border-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-500 appearance-none flex flex-row items-center justify-between">
