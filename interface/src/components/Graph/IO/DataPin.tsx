...
export const DataPin = (props: Props) => {
	...
	const triggerClass =
		"cursor-auto rounded-full focus-visible:outline-transparent outline-offset-1 outline-[0.1px] transition-opacity duration-100 data-[dim=true]:opacity-20";
	...
	return (
		...
		>
			<Tooltip.Root>
				<Tooltip.Trigger data-dim={dim()} class={triggerClass}>
					{pinShape()}
				</Tooltip.Trigger>
				<Tooltip.Portal>
