...
export const subscriptionTypes = {
	...
	channelChatMessage: {
		...
		event: {
			...
			badges: S.Array(
				S.Struct({ set_id: S.String, id: S.String, info: S.String }),
			),
			...
			source_badges: S.NullOr(
				S.Array(S.Struct({ set_id: S.String, id: S.String, info: S.String })),
			),
	...
	channelChatNotification: {
		...
		event: {
			...
			prime_paid_upgrade: S.NullOr(S.Struct({ sub_tier: S.String })),
			...
			announcement: S.NullOr(S.Struct({ color: S.String })),
			...
			shared_chat_announcement: S.NullOr(S.Struct({ color: S.String })),
		},
	},
				...
				S.Struct({
					...
					fragments: S.Array(
						S.Struct({
							...
							emote: S.NullOr(S.Struct({ id: S.String })),
						}),
					),
				}),
			),
	...
	dropEntitlementGrant: {
		...
		version: 1,
		condition: { organization_id: S.String },
		event: {
			id: S.String,
	...
	userWhisperMessage: {
		...
		event: {
			...
			whisper: S.Struct({ text: S.String }),
		},
	},
	channelPointsCustomRewardAdd: {
		...
		event: {
			...
			max_per_stream: S.Struct({ is_enabled: S.Boolean, value: S.Number }),
			...
			image: S.NullOr(
				S.Struct({ url_1x: S.String, url_2x: S.String, url_4x: S.String }),
			),
			...
			global_cooldown: S.Struct({ is_enabled: S.Boolean, seconds: S.Number }),
