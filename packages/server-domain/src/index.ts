...
import { ConnectionRpcMiddleware, CurrentActorRpcMiddleware } from "./Realtime";
...
export const EditorRpcs = RpcGroup.make(
	...
	Rpc.fromTaggedRequest(Request.SetNodeFoldPins),
...
export const ServerRpcs = Presence.Rpcs.merge(
	CloudAuth.Rpcs,
	ClientAuth.Rpcs,
	Credential.Rpcs,
);
