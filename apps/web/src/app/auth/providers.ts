...
> => ({
	twitch:
		serverEnv().TWITCH_CLIENT_ID && serverEnv().TWITCH_CLIENT_SECRET
			? {
	...
	google:
		serverEnv().GOOGLE_CLIENT_ID && serverEnv().GOOGLE_CLIENT_SECRET
			...
			: undefined,
	patreon:
		serverEnv().PATREON_CLIENT_ID && serverEnv().PATREON_CLIENT_SECRET
			? {
			...
			: undefined,
	streamlabs:
		serverEnv().STREAMLABS_CLIENT_ID && serverEnv().STREAMLABS_CLIENT_SECRET
			? {
