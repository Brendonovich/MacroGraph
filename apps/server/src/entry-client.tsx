import { Option, Config, ConfigProvider, Effect, Layer,ManagedRuntime } from "effect";
...
const runtime = ManagedRuntime.make(EffectRuntime.layer.pipe(
	Layer.provide(TracingLive),
	Layer.provide(ImportMetaEnvConfig),
))

Layer.mergeAll(RegisterPackages, UILive(runtime)).pipe(Layer.launch, runtime.runPromise);
